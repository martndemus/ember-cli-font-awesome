...
- If you want to ensure the AST transforms of this addon are not being cached, you can use the `EMBER_CLI_FONT_AWESOME_DISABLE_CACHE`
  environment variables when calling `ember build`
